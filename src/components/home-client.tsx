    ...
    <div className="bg-background text-foreground overflow-x-hidden">
      ...
      <main>
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <div className="flex justify-center -space-x-4">
                    <motion.div initial={{ opacity: 0, scale: 0.5 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0 }}>
                        <Image src="/team/member-1.webp" alt="Team member 1" width={100} height={100} className="rounded-full border-4 border-background" data-ai-hint="person portrait" />
                    </motion.div>
                    <motion.div initial={{ opacity: 0, scale: 0.5 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.1 }}>
                        <Image src="/team/member-2.webp" alt="Team member 2" width={100} height={100} className="rounded-full border-4 border-background" data-ai-hint="person portrait" />
                    </motion.div>
                    <motion.div initial={{ opacity: 0, scale: 0.5 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.2 }}>
                        <Image src="/team/member-3.webp" alt="Team member 3" width={100} height={100} className="rounded-full border-4 border-background" data-ai-hint="person portrait" />
                    </motion.div>
                    <motion.div initial={{ opacity: 0, scale: 0.5 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.3 }}>
                        <Image src="/team/member-4.webp" alt="Team member 4" width={100} height={100} className="rounded-full border-4 border-background" data-ai-hint="person portrait" />
                    </motion.div>
                    <motion.div initial={{ opacity: 0, scale: 0.5 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.4 }}>
                        <Image src="/team/member-5.webp" alt="Team member 5" width={100} height={100} className="rounded-full border-4 border-background" data-ai-hint="person portrait" />
                    </motion.div>
                </div>
            </div>
        </section>
        ...
        <footer id="contact" className="py-16 bg-background border-t border-border/20">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
                {logoSrc && <Image src="/ESBlogo.png" alt="ESchoolBooks Logo" width={80} height={80} className="mx-auto mb-4 bg-white rounded-full shadow-2xl p-2"/>}
